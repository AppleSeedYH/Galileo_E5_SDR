...
config.SP_CORR    = 0.25;            % default correlator spacing (chip) (E-L)/2
...
config.THRES_CN0  = [35.0, 35.0];    % C/N0 threshold (dB-Hz) (lock, lost) (acq lock, declaring trk lost)
...
%% test for E5b
config.sampleFilePath='D:\LocalCode\handover code\dataset\L5b_IF20KHz_FS18MHz.bin';
...
% config.navFilePath = '';
config.navFilePath = 'D:\LocalCode\handover code\galileo e5 sdr\navSave.mat'; % a .mat file storing the .nav struct 
